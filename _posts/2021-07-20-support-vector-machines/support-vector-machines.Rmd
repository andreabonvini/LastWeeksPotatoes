...
output:
  distill::distill_article:
    ...
    toc: true
    toc_depth: 2
preview: media/outer_points2D-white.png
---
...
<center>
![](media/03_who_are_the_support_vectors-white.png){width=60%}
</center>
...
<center>
![](media/04_margins-white.png){width=60%}
</center>

The *margins* from the support vectors to the hyperplane are drawed in red

<center>
![](media/05_distances-white.png){width=60%}
</center>
...
<center>
![](media/outer_points2D-white.png){width=60%}
</center>
